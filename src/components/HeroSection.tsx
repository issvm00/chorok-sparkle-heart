  ...
  return (
    <section className="relative z-20 flex flex-col items-center justify-center min-h-screen px-4 py-12 snap-start">
      <div className="text-center">
        ...
        <div
          className={`mb-4 transition-all duration-[1500ms] ease-out ${stage >= 1 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-16"}`}
        >
        ...
        {/* Decorative line */}
        <div
          className={`transition-all duration-1000 ${stage >= 2 ? "opacity-100 scale-x-100" : "opacity-0 scale-x-0"}`}
        >
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="w-12 h-[1px] animate-shimmer rounded-full" />
            <span
              className="text-xs tracking-[0.6em] uppercase font-light"
              style={{ color: "hsl(var(--secondary) / 0.6)" }}
            >
              Happy Birthday
            </span>
            <div className="w-12 h-[1px] animate-shimmer rounded-full" />
        ...
        <div className={`transition-all duration-700 ${stage >= 3 ? "opacity-100" : "opacity-0"}`}>
          ...
          {stage >= 3 && nameChars < name.length && (
            <span
              className="inline-block w-[3px] h-14 ml-1 animate-pulse align-bottom"
        ...
        <div
          className={`transition-all duration-1000 ${stage >= 4 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        >
          <div className="relative inline-block mt-3">
            ...
            />
            <p
              className="relative font-panorama text-5xl md:text-6xl font-bold"
              style={{ color: "hsl(var(--secondary) / 0.8)" }}
            >
              شروق
            </p>
          </div>
        ...
        <div className={`transition-all duration-1000 ${stage >= 5 ? "opacity-100" : "opacity-0"}`}>
          ...
          <p className="font-panorama text-base text-muted-foreground/40">✦ كل عام و أنت بألف خير ✦</p>
        </div>
        ...
        <div className={`mt-16 transition-all duration-1000 ${stage >= 6 ? "opacity-100" : "opacity-0"}`}>
          <div className="flex flex-col items-center gap-2">
            ...
            >
              <div
                className="w-1 h-2 rounded-full animate-scroll-dot"
